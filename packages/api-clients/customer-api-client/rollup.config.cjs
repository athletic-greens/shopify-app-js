...
const config = [
  {
    ...
    output: [
      {
        file: './dist/umd/customer-api-client.min.js',
        format: 'umd',
        sourcemap: true,
        name: 'ShopifyCustomerAPIClient',
        ...bannerConfig,
      },
    ],
  },
  {
    ...
    output: [
      {
        file: './dist/umd/customer-api-client.js',
        format: 'umd',
        sourcemap: true,
        name: 'ShopifyCustomerAPIClient',
        ...bannerConfig,
  ...
  }),
  {
    ...
    output: [{file: 'dist/customer-api-client.d.ts', format: 'es'}],
    plugins: [dts.default()],
  },
];
